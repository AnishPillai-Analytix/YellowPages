...
from chamber_of_commerce import ChamberOfCommerce
...
sources = ['Chamber of Commerce', 'Yellow Pages', 'Yelp']
...
def run_gui():
    ...
    main_layout = [
        ...
        [sg.Tree(data=status, headings=['   Status   '], key='status', visible=True, col0_width=25, def_col_width=20,
